...
namespace Neovim.Editor
{
  public class NeovimChangeOpenFileRequestArgs : EditorWindow
  {
    ...
    {
      string current_args = NeovimCodeEditor.s_Config.OpenFileArgs;
      ...
      {
        label = "arguments",
        tooltip = "Arguments to be passed to Neovim when you click on a file/msg from console and a Neovim server instance is already running. "
      ...
      update_btn.clicked += () =>
      {
        NeovimCodeEditor.s_Config.OpenFileArgs = args_field.value;
